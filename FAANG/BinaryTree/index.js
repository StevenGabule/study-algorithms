...
class BinarySearchTree {
  ...
  /** 
   * @desc It creates a new node with a value data, if the tree is empty it add this node to a tree and make it a root, 
   * otherwise it calls insert(node, data).
   * @desc Helper method which creates a new node to be inserted and calls insertNode
   */
  insert(data) {
