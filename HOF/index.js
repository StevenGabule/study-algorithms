...
function gatherCorrelationsV1(journal) {
  var phis = {}
...
console.log(greaterThan10(11)); // return true

var greaterThanSample = greaterThan(10)(11);
console.log(greaterThanSample);
...
console.log(string);
// 1> {"name":"X",born:1980} console.log(JSON.parse(string).born);
...
let ancestryFile = JSON.stringify(ANCESTRY_FILE);
...
// my most ancient known ancestor, we can write
// something like this:
...
console.log(min); // 1> {name: "Pauwels van Haverbeke", born: 1535, ...}
...
var byName = {}
function reduceAncesstors(person, f, defaultValue) {
  function valueFor(person) {
    if(person == null) return defaultValue 
    else return f(person, valueFor(byName[person.mother]), valueFor(byName[person.father]))
  }
...
console.log(reduceAncesstors(ph, sharedDNA, 0) / 4) // 0.00049
...
function countAncestors(person, test) {
  ...
  return reduceAncesstors(person, combine, 0)
}
