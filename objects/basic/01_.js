...
// whiteRabbit.speak("MTF")
// hungryRabbit.speak("MEAT!")
...
let killerRabbit1 = new RabbitOne("killer");
let blackRabbit = new RabbitOne("black");
...
console.log(`Júlia is ${ages1.get("Júlia")}`); // → Júlia is 62
console.log("Is Jack's age known?", ages1.has("Jack")); // → Is Jack's age known? false
...
let matrixNew = new SymmetricMatrix(5, (x, y) => `${x},${y}`);
console.log(matrixNew.get(2, 3));// → 3,2
